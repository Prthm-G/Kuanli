...
export async function GET(
  ...
  try {
    ...
    // Fetch and decrypt WhatsApp config. Multi-number (034): media lives on the
    // shared WABA, so any of the account's numbers can fetch it — use the
    // primary config's token.
    let config
    try {
