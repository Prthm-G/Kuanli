...
const navItems: NavItem[] = [
  ...
  { href: '/reports', label: 'EOD Report', icon: ClipboardList },
    ...
    <>
      ...
      >
        ...
        <div className="border-border flex h-14 shrink-0 items-center justify-between gap-2 border-b px-4">
          <Link
            href="/dashboard"
            className="mx-2 my-1 flex items-center gap-3 rounded-xl px-3 py-2 shadow-md transition-all hover:opacity-90"
